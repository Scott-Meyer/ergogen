...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      ${''/* middle shaft */}
      (pad "" np_thru_hole circle (at 0 0 90) (size 4.8 4.8) (drill 4.8) (layers F&B.Cu *.Mask))
    ...
    function pins(def_neg, def_pos, def_side) {
      if(p.param.hotswap) {
        return `
          ...
          ${'' /* v2 pin */}
          (pad "" np_thru_hole circle (at ${def_neg}5 5.55) (size 2 2) (drill 1) (layers *.Cu "B.Mask"))
